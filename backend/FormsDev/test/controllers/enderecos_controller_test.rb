...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { cep: @endereco.cep, endereco: @endereco.endereco, logradouro: @endereco.logradouro, numero: @endereco.numero } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { cep: @endereco.cep, endereco: @endereco.endereco, logradouro: @endereco.logradouro, numero: @endereco.numero } }
