...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { cnpj: @empresa.cnpj, data_de_criacao: @empresa.data_de_criacao, nome: @empresa.nome } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cnpj: @empresa.cnpj, data_de_criacao: @empresa.data_de_criacao, nome: @empresa.nome } }
